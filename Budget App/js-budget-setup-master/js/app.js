...
submitBudgetForm() {
  const value = this.budgetInput.value;
    if(value === "" || value < 0) {
      ...
      this.budgetFeedback.innerHTML = `<p>value cannont be empty or negative </p>`
...
submitExpenseForm() {
  ...
  editExpense(element) {
    ...
    let editedItem = this.itemList.filter(item => {
      return item.id == id;
    });
    this.expenseInput.value = editedItem[0].title;
    this.amountInput.value = editedItem[0].amount;
